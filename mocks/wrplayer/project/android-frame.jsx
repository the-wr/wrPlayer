  ...
  return (
    <div style={{
      ...
      <div style={{ width: 128, display: 'flex', alignItems: 'center', gap: 8 }}>
        <span style={{ fontSize: 14, fontWeight: 500, letterSpacing: 0.25, lineHeight: '20px', color: c }}>9:30</span>
      </div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'var(--device-fg)', opacity: 0.4,
      }} />
    </div>
  );
}
...
function AndroidDevice({
  ...
  return (
    <div style={{
      ...
      border: `9px solid var(--device-border)`,
